...
void GetDrawRect(const HWND hWnd, const UINT uiID, LPCTSTR lpszString, LPRECT lpRect)
{
	RECT	rectTxt;
	HDC		hDC;
	...
	rectTxt = *lpRect;
	hDC = GetDC(hWnd);
	DrawText (hDC, lpszString, -1, &rectTxt, DT_CALCRECT | DT_CENTER | DT_SINGLELINE);
