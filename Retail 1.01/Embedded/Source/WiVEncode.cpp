...
//#define	WIV_VERSION_TYPE	SSS_VERSION_TYPE
//#define	WIV_VERSION_MAJOR	SSS_VERSION_MAJOR
//#define	WIV_VERSION_MINOR	SSS_VERSION_MINOR
//#define	WIV_VERSION_BUILD	SSS_VERSION_BUILD
...
//=====================
	...
	char	szProductVersion[]				= "1.01";
	char	szProductType[]					= "Retail";
	char	szProductBuild[]				= "0706";
...
//=====================
	...
	char	szRegButtonAction[]				= "ButtonAction";
	...
	char	szRegDefaultSIMID[]				= "DefaultSIMID";
...
//=====================
	...
	char	szHelpTagPINEntrySettings[]		= "pinentry_settings";
...
//=====================
	...
	char	szCoreDLL[]						= "coredll.dll";
	char	szSMSReceiver[]					= "SMSReceiver_dll.dll";
	char	szSMSProviders[]				= "sms_providers.dll";
	...
	char	szLinkText[]					= "file:ctlpnl.exe cplmain.cpl";
...
//=====================
	...
	nLen = strlen(szRegButtonAction);
	pm_SSS_Special->bStringData[nStringsByteIndex++] = nLen;
	memcpy(&pm_SSS_Special->bStringData[nStringsByteIndex], szRegButtonAction, nLen);
	nStringsByteIndex += nLen;
	dwStringCount += 1;
	TraceCode(_D("\r\n#define g_szRegButtonAction (WiV::GlobalGetString(%d)) // (\"%S\")"), 
		dwStringCount, szRegButtonAction);
	...
	nLen = strlen(szRegDefaultSIMID);
	pm_SSS_Special->bStringData[nStringsByteIndex++] = nLen;
	memcpy(&pm_SSS_Special->bStringData[nStringsByteIndex], szRegDefaultSIMID, nLen);
	nStringsByteIndex += nLen;
	dwStringCount += 1;
	TraceCode(_D("\r\n#define g_szRegDefaultSIMID (WiV::GlobalGetString(%d)) // (\"%S\")"), 
		dwStringCount, szRegDefaultSIMID);
...
//=====================
	...
	nLen = strlen(szHelpTagPINEntrySettings);
	pm_SSS_Special->bStringData[nStringsByteIndex++] = nLen;
	memcpy(&pm_SSS_Special->bStringData[nStringsByteIndex], szHelpTagPINEntrySettings, nLen);
	nStringsByteIndex += nLen;
	dwStringCount += 1;
	TraceCode(_D("\r\n#define g_szHelpTagPINEntrySettings (WiV::GlobalGetString(%d)) // (\"%S\")"), 
			  dwStringCount, szHelpTagPINEntrySettings);
...
//=====================
	...
	nLen = strlen(szCoreDLL);
	pm_SSS_Special->bStringData[nStringsByteIndex++] = nLen;
	memcpy(&pm_SSS_Special->bStringData[nStringsByteIndex], szCoreDLL, nLen);
	nStringsByteIndex += nLen;
	dwStringCount += 1;
	TraceCode(_D("\r\n#define g_szCoreDLL (WiV::GlobalGetString(%d)) // (\"%S\")"), 
						dwStringCount, szCoreDLL);
	...
	nLen = strlen(szSMSProviders);
	pm_SSS_Special->bStringData[nStringsByteIndex++] = nLen;
	memcpy(&pm_SSS_Special->bStringData[nStringsByteIndex], szSMSProviders, nLen);
	nStringsByteIndex += nLen;
	dwStringCount += 1;
	TraceCode(_D("\r\n#define g_szSMSProviders (WiV::GlobalGetString(%d)) // (\"%S\")"), 
		dwStringCount, szSMSProviders);
...
//=====================
	...
	nLen = sizeof(DWORD);
	pm_SSS_Special->bDWordData[nDWordsByteIndex++] = nLen;
	memcpy(&pm_SSS_Special->bDWordData[nDWordsByteIndex], &dwTodayIconSetTube, nLen);
	nDWordsByteIndex += nLen;
	dwDWordCount += 1;
	TraceCode(_D("\r\n#define g_dwTodayIconSetTube (WiV::GlobalGetDword(%d)) // (0x%08X)"), dwDWordCount, dwTodayIconSetTube);
