...
friend	LRESULT	CALLBACK	OptionsDlgProcPINEntry(HWND hDlg, UINT uMsg, WPARAM wParam, LPARAM lParam);
...
LRESULT	DlgProcPINEntry(HWND hWnd, UINT wMsg, WPARAM wParam, LPARAM lParam);
...
void	DrawSecurityHeader(HWND hWnd, UINT uID);
...
LPCTSTR	SetupPINEntryPage(HWND hWnd, bool blFromPaint = false);
